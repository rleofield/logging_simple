...
#ifdef L_B_DEBUG
#define LOGT_B_DEBUG(exp)  (logger().log( LfmCL(__LINE__,__FILE__,__FUNCTION__, eCategory::Cat_B, eLevel::DEBUG, (exp) )))
...
#define LOGT_B_ERROR(exp)  (logger().log( LfmCL(__LINE__,__FILE__,__FUNCTION__, eCategory::Cat_B, eLevel::ERROR_, (exp)  )))
